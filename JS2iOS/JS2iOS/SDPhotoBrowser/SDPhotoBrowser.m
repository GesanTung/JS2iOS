...
//    [self addSubview:indexLabel];
    ...
    saveButton.frame = CGRectMake(30, self.bounds.size.height - 70, 40, 40);
    ...
    saveButton.layer.cornerRadius = saveButton.bounds.size.height * 0.5;
...
- (void)photoClick:(UITapGestureRecognizer *)recognizer
{
    ...
    UIView *sourceView = self.sourceImagesContainerView.subviews.firstObject?:self.sourceImagesContainerView;
